      ...
      <section className="py-16 bg-gradient-to-br from-primary/10 to-secondary/10 border-b border-border">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            Join us in creating social change. Explore career and volunteer
            opportunities.
          </p>
        </div>
      </section>
            ...
            {[
              {
                title: "Volunteer",
                description:
                  "Share your skills and time with our programs and communities",
              },
              {
                title: "Partner With Us",
                description:
                  "Organizations and institutions can partner with PSTC",
              },
              {
                title: "Advocate",
