      ...
      <section className="py-16 bg-gradient-to-br from-primary/10 to-secondary/10 border-b border-border">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            Our comprehensive approach to social development works across
            multiple interconnected thematic areas.
          </p>
        </div>
      </section>
              ...
              <Card key={project.id} className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {project.locations.length} districts
                    </p>
                  </div>
                </div>
              </Card>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Whether you want to support our work, volunteer, or partner with us,
